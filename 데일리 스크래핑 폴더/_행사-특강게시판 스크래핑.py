...
url = "https://www.duksung.ac.kr/bbs/board.do?menuId=1062&bsIdx=40"
...
for d in dataList:
    b_idx = d['B_IDX']
    post_url = f"https://www.duksung.ac.kr/bbs/boardView.do?bsIdx=40&bIdx={b_idx}&menuId=1062&bcIdx=0&searchCondition=SUBJECT&searchKeyword="
...
data = {
    ...
    'isduksung': True,  # 현재 스크래핑 코드에서는 isduksung 값을 가져오지 않았으므로 True로 설정
...
# CSV 파일로 저장
df.to_csv('1204community_post_event_pg1.csv', index=False)